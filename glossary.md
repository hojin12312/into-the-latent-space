...
- **기술 부채** (technical debt) — 빨리 끝내려고 미뤄둔 일이 나중에 이자처럼 불어나는 비용. 빚 자체가 나쁜 게 아니라, 빚이 있다는 걸 잊는 게 위험함. → [11화](chapters/11-technical-debt.md)
...
- **이해 부채** (comprehension debt) — AI 가 만들어준 결과물의 양과, 사람이 실제로 이해한 양 사이에 벌어지는 격차. 마찰 신호가 없어 가짜 자신감을 키우며 조용히 쌓임. → [11화](chapters/11-technical-debt.md)
- **인지 부채** (cognitive debt) — AI 에 계속 의존하면서 사람 본인의 능력이 약해지는 현상. 안 쓰는 근육이 약해지는 것과 같은 원리. → [11화](chapters/11-technical-debt.md)

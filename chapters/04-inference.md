...
> **더 깊이 들어가려면**: 모델이 토큰 하나를 뽑을 때 내부에서 어떤 두 단계 — Prefill 과 Decode — 를 거치는지는 [`transformer-inference`](https://github.com/hojin12312/llm-field-notes/blob/main/appendix/theory/transformer-inference.md) 부록에서 자세히 다뤄요.

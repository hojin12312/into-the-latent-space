...
> **더 깊이 들어가려면**: 환각을 줄이는 RAG 가 실제로 어떻게 짜이는지 — 검색·청킹·리랭킹·벡터DB 같은 구성요소 — 는 [`rag-architecture`](https://github.com/hojin12312/lecture-claude-code/blob/main/appendix/rag-architecture.md) 부록에서 자세히 다뤄요.

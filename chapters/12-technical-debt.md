...
> **더 깊이 들어가려면**: 머신러닝 시스템 자체에 숨어 있는 부채(파이프라인 정글·CACE 원칙 — "뭐든 하나 바꾸면 전부 바뀐다") 와 AI 가 써준 코드가 만드는 구체적 부채 통계(복잡도 41%↑ · 디버깅 시간 증가 · 인지 부채 17%↓) 의 디테일은 [`ai-technical-debt`](https://github.com/hojin12312/llm-field-notes/blob/main/appendix/tools/ai-technical-debt.md) 부록에서 자세히 다뤄요.

...
- [`llm-field-notes`](https://github.com/hojin12312/llm-field-notes): 같은 저자의 자매편. 개발자·ML 관심층용. KV 캐시, 트랜스포머 추론, 메모리 대역폭, 에이전트 설계 같은 더 기술적인 주제를 다뤄요. 이 글의 비유 위에 한 층 더 깊이 올려놓고 싶으시다면 권해드려요.

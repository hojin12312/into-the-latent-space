...
11편의 본편에서 우리는 같이 이 잠재 공간의 작동 방식을 더듬어왔어요. 이제 돌아보면 — 우리도 모르는 사이 latent space 한가운데까지 들어와 있었어요. 시작은 휴대폰 자판이라는 익숙한 풍경에서 출발했지만, 끝에 와서는 단어들의 좌표 공간을 이야기하고 있어요. 제목 그대로 — 우리는 latent space 안으로 산책을 다녀온 거예요.

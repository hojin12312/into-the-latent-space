...
> **더 깊이 들어가려면**: 그 폭발적 비용을 누그러뜨리는 핵심 기법인 KV 캐시가 무엇이고 왜 그것이 모델 운영 비용의 80% 이상을 결정하는지는 [`kv-cache`](https://github.com/hojin12312/lecture-claude-code/blob/main/appendix/kv-cache.md) 부록에서 자세히 다뤄요.
